use super::World;
use crate::consts::*;
use crate::draw::floor::{LiquidDraw, TiledDraw};
...
impl Material {
    ...
    pub fn to_vertex_draw(self, world: &World, vertices: &[Vec2]) -> VertexDraw {
        match self {
...
pub fn spawn_floor(world: &mut World, vertices: Vec<Vec2>, material: Material) {
    ...
    let vertex_draw = material.to_vertex_draw(world, &vertices);
